...
public final class ErrorCode {
	...
	public static final String PA_TAX_CODE_MUST_NOT_BE_NULL_MSG								= MODULE_ID + "000034";
	
	public static final String SUBSCRIBER_ID_CODE_MUST_NOT_BE_NULL_MSG						= MODULE_ID + "000035";
	public static final String SUBSCRIBER_ID_MUST_MATCH_REGEXP_MSG 							= MODULE_ID + "000036";
	
	public static final String PRESET_ID_MUST_NOT_BE_NULL_MSG								= MODULE_ID + "000037";
	public static final String PRESET_ID_MUST_MATCH_REGEXP_MSG 								= MODULE_ID + "000038";
